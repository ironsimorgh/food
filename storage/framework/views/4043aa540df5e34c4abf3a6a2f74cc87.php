                                            ...
                                            <div class="col-xl-3 col-md-6">          
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <select name="client_id"class="form-select">
                                                            ...
                                                            <option value="<?php echo e($clie->id); ?>"><?php echo e($clie->name); ?></option>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        </select>
                                                    </div>
                                            </div>
...
<?php echo $__env->make('admin.admin_dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Pro3\food\resources\views\admin\backend\product\add_product.blade.php ENDPATH**/ ?>