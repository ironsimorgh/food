                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12">
                                ...
                                <form id="myForm" action="<?php echo e(route('admin.product.update')); ?>" method="post" enctype="multipart/form-data">
                                 <?php echo csrf_field(); ?>
                                            ...
                                            <div class="col-xl-3 col-md-6">          
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <select name="client_id"class="form-select">
                                                            ...
                                                            <option value="<?php echo e($clie->id); ?>" <?php echo e($clie->id == $product->client_id ? 'selected' : ''); ?>><?php echo e($clie->name); ?></option>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        </select>
                                                    </div>
                                            </div>
...
<?php echo $__env->make('admin.admin_dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Pro3\food\resources\views\admin\backend\product\edit_product.blade.php ENDPATH**/ ?>