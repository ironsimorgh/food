        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="<?php echo e(route('admin.pending.review')); ?>" data-key="t-lightbox">Pending Review</a></li>
                        <li><a href="<?php echo e(route('admin.approve.review')); ?>" data-key="t-range-slider">Approve Review</a></li>
                    </ul>
                </li>
