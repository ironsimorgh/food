            ...
            <div class="bg-white card addresses-item mb-4 border border-success">
                ...
                <div class="media">
                    ...
                    <div class="media-body">
                        ...
                        <p class="text-black"><?php echo e($profileData->address); ?>
               ...
               <div class="col-md-4">
                  <div class="generator-bg rounded shadow-sm mb-4 p-4 osahan-cart-item">
                     <div class="d-flex mb-4 osahan-cart-item-profile">
                        <img class="img-fluid mr-3 rounded-pill" alt="osahan" src="<?php echo e((!empty($profileData->phone)) ? url('upload/user_images/'.$profileData->photo) : url('upload/no_image.jpg')); ?> ">
                        <div class="d-flex flex-column">
                           <h6 class="mb-1 text-white"><?php echo e($profileData->name); ?>

                           </h6>
                           <p class="mb-0 text-white"><i class="icofont-location-pin"></i><?php echo e($profileData->address); ?></p>
                        </div>
                     </div>
...
<?php echo $__env->make('frontend.dashboard.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Pro3\food\resources\views\frontend\checkout\view_chechout.blade.php ENDPATH**/ ?>